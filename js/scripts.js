...
questionsNumberElement = document.getElementById('questions-number');
rangeInputElement = document.getElementById('range-input');

timeOptionsElement = document.getElementById('time-options');
...
const getQuestionsQuantity = event => {
	questionsNumberElement.textContent = rangeInputElement.value;

	const questionsQuantity = rangeInputElement.value;
	console.log(questionsQuantity);
};
rangeInputElement.addEventListener('input', getQuestionsQuantity);

//TIEMPO POR PREGUNTA + TEMPORIZADOR
const getTimePerQuestion = event => {
	console.log('holaquetal');
};

timeOptionsElement.addEventListener('change', getTimePerQuestion);
